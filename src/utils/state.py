...
def add_docs(existing: list, new: list) -> list:
    ...
    Args:
        existing (list): Existing documents.
        new (list): New documents to append.
    
    Returns:
        list: Updated list of documents.
    """
    return existing + new
...
class ResearchState(MessagesState):
    ...
    search_results: Annotated[list[dict], add_docs] # reducer for accumulated search results
